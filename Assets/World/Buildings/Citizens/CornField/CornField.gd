...
const CORN_FIELD_IDLE = preload("res://Assets/World/Buildings/Citizens/CornField/Sprites/CornField_idle.png")
const CORN_FIELD_IDLE_FULL = preload("res://Assets/World/Buildings/Citizens/CornField/Sprites/CornField_idle_full.png")

const CORN_FIELD_WORK_ANIM = preload("res://Assets/World/Buildings/Citizens/CornField/Sprites/CornField_work_anim.png")
