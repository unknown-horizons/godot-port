...
const COCOA_FIELD_IDLE = preload("res://Assets/World/Buildings/Citizens/CocoaField/Sprites/CocoaField_idle.png")
const COCOA_FIELD_IDLE_FULL = preload("res://Assets/World/Buildings/Citizens/CocoaField/Sprites/CocoaField_idle_full.png")

const COCOA_FIELD_WORK_ANIM = preload("res://Assets/World/Buildings/Citizens/CocoaField/Sprites/CocoaField_work_anim.png")
