...
const BAKERY_IDLE = preload("res://Assets/World/Buildings/Citizens/Bakery/Sprites/Bakery_idle.png")

const BAKERY_WORK_ANIM = preload("res://Assets/World/Buildings/Citizens/Bakery/Sprites/Bakery_work_anim.png")
