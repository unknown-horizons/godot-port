...
const HOP_FIELD_IDLE = preload("res://Assets/World/Buildings/Citizens/HopField/Sprites/HopField_idle.png")
const HOP_FIELD_IDLE_FULL = preload("res://Assets/World/Buildings/Citizens/HopField/Sprites/HopField_idle_full.png")

const HOP_FIELD_WORK_ANIM = preload("res://Assets/World/Buildings/Citizens/HopField/Sprites/HopField_work_anim.png")
