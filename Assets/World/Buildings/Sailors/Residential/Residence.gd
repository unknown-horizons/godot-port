...
# Tiers
const RESIDENTIAL_TENT = "res://Assets/World/Buildings/Sailors/Residential/Residence.tscn"
const RESIDENTIAL_HUT = "res://Assets/World/Buildings/Pioneers/Residential/Residence.tscn"
const RESIDENTIAL_HOUSE_TIMBER_FRAMED = "res://Assets/World/Buildings/Settlers/Residential/Residence.tscn"
const RESIDENTIAL_STONE_HOUSE = "res://Assets/World/Buildings/Citizens/Residential/Residence.tscn"
...
const RESIDENTIAL_TENT_2_IDLE_45 = preload("res://Assets/World/Buildings/Sailors/Residential/Sprites/Tent2_idle_45.png")
const RESIDENTIAL_TENT_2_IDLE_135 = preload("res://Assets/World/Buildings/Sailors/Residential/Sprites/Tent2_idle_135.png")
const RESIDENTIAL_TENT_2_IDLE_225 = preload("res://Assets/World/Buildings/Sailors/Residential/Sprites/Tent2_idle_225.png")
const RESIDENTIAL_TENT_2_IDLE_315 = preload("res://Assets/World/Buildings/Sailors/Residential/Sprites/Tent2_idle_315.png")
...
const RESIDENTIAL_HUT_1_IDLE = preload("res://Assets/World/Buildings/Pioneers/Residential/Sprites/Hut1_idle.png")
const RESIDENTIAL_HUT_2_IDLE = preload("res://Assets/World/Buildings/Pioneers/Residential/Sprites/Hut2_idle.png")
const RESIDENTIAL_HUT_3_IDLE = preload("res://Assets/World/Buildings/Pioneers/Residential/Sprites/Hut3_idle.png")

# Tier 3 (Settlers) Resources
const RESIDENTIAL_HOUSE_TIMBER_FRAMED_1_IDLE = preload("res://Assets/World/Buildings/Settlers/Residential/Sprites/HouseTimberFramed1_idle.png")
const RESIDENTIAL_HOUSE_TIMBER_FRAMED_2_IDLE = preload("res://Assets/World/Buildings/Settlers/Residential/Sprites/HouseTimberFramed2_idle.png")
const RESIDENTIAL_HOUSE_TIMBER_FRAMED_3_IDLE = preload("res://Assets/World/Buildings/Settlers/Residential/Sprites/HouseTimberFramed3_idle.png")

# Tier 4 (Citizens) Resources
const RESIDENTIAL_STONE_HOUSE_1_IDLE = preload("res://Assets/World/Buildings/Citizens/Residential/Sprites/StoneHouse1_idle.png")
const RESIDENTIAL_STONE_HOUSE_2_IDLE = preload("res://Assets/World/Buildings/Citizens/Residential/Sprites/StoneHouse2_idle.png")
const RESIDENTIAL_STONE_HOUSE_3_IDLE = preload("res://Assets/World/Buildings/Citizens/Residential/Sprites/StoneHouse3_idle.png")
const RESIDENTIAL_STONE_HOUSE_4_IDLE = preload("res://Assets/World/Buildings/Citizens/Residential/Sprites/StoneHouse4_idle.png")
