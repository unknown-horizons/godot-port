...
const TOOLMAKER_IDLE = preload("res://Assets/World/Buildings/Settlers/Toolmaker/Sprites/Toolmaker_idle.png")

const TOOLMAKER_WORK_ANIM = preload("res://Assets/World/Buildings/Settlers/Toolmaker/Sprites/Toolmaker_work_anim.png")
