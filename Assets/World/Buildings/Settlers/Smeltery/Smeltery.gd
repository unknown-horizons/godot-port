...
const SMELTERY_IDLE = preload("res://Assets/World/Buildings/Settlers/Smeltery/Sprites/Smeltery_idle.png")

const SMELTERY_WORK_ANIM = preload("res://Assets/World/Buildings/Settlers/Smeltery/Sprites/Smeltery_work.png")
