...
const CHARCOAL_BURNING_IDLE = preload("res://Assets/World/Buildings/Settlers/CharcoalBurning/Sprites/CharcoalBurning_idle.png")
const CHARCOAL_BURNING_IDLE_FULL = preload("res://Assets/World/Buildings/Settlers/CharcoalBurning/Sprites/CharcoalBurning_idle_full.png")

const CHARCOAL_BURNING_WORK_ANIM = preload("res://Assets/World/Buildings/Settlers/CharcoalBurning/Sprites/CharcoalBurning_work_anim.png")
