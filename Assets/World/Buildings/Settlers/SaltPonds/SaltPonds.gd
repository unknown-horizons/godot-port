...
const SALT_POND_IDLE = preload("res://Assets/World/Buildings/Settlers/SaltPonds/Sprites/SaltPond_idle.png")
const SALT_POND_IDLE_FULL = preload("res://Assets/World/Buildings/Settlers/SaltPonds/Sprites/SaltPond_idle_full.png")

const SALT_POND_WORK_ANIM = preload("res://Assets/World/Buildings/Settlers/SaltPonds/Sprites/SaltPond_work_anim.png")
